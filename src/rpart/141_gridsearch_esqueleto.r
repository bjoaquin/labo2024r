...
PARAM$semillas <- c(100151, 100333, 100393, 100411, 100447)
...
for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
    for (vcp in c(-10, -1, -0,01, -0.0000001)) {
      for (vmin_bucket_mult in c(2, 3, 5)) {
        ...
        param_basicos <- list(
          "cp" = vcp,
          "minsplit" = vmin_split,
          "minbucket" = round(vmin_split/vmin_bucket_mult),
          "maxdepth" = vmax_depth
        ...
        tb_grid_search <- rbindlist( 
          list(
            ...
            list(
              vmax_depth, 
              vmin_split, 
              round(vmin_split/vmin_bucket_mult),
              vcp, 
              ganancia_promedio)
          )
        )
