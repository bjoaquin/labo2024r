...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106, 202105, 202104, 202103, 202102,
    202101, 202002, 202001, 202012, 202011, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905,
...
wf_septiembre <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm_semillerio( c(ht, ts9), ranks=c(1), semillerio=20, repeticiones_exp=7 )
